...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `<div class="flex flex-wrap flex-col justify-center items-center content-between h-full"><form method="POST">${validate_component(
		...
		{
			default: () => {
				return `${validate_component(SubmitButton, 'SubmitButton').$$render($$result, { name: 'Signup' }, {}, {})}`;
			}
		}
	)}</form> <a href="/auth/login" class="mx-auto text-center w-full p-3 underline" data-svelte-h="svelte-mjz7n2">Login</a></div>`;
});
