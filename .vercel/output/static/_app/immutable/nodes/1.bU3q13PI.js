...
import { S as q, i as y } from '../chunks/index.Ci6sy3Wu.js';
import { s as C } from '../chunks/entry.Cxr1BC7q.js';
const H = () => {
		const s = C;
		return {
...
function w(s) {
	...
	return {
		c() {
			(t = _('h1')), (o = f(r)), (n = x()), (i = _('p')), (u = f(c));
		},
		l(e) {
			t = d(e, 'H1', {});
			var a = g(t);
			(o = h(a, r)), a.forEach(l), (n = j(e)), (i = d(e, 'P', {}));
			var p = g(i);
			(u = h(p, c)), p.forEach(l);
		},
		m(e, a) {
		...
		p(e, [a]) {
			...
			a & 1 && r !== (r = e[0].status + '') && $(o, r),
				a & 1 && c !== (c = ((p = e[0].error) == null ? void 0 : p.message) + '') && $(u, c);
		},
		i: E,
		o: E,
		d(e) {
